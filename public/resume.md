...
- Deployed **multi-agentic workflow** for product matching, improving match rates by **3.1-3.3 percentage points** (73.8%→76.9%) and unlocking **$165M in GMV**; achieved **15% full automation** with **LLM-as-a-Judge guardrails** at **97% accuracy**, automating **50+ hours of manual operations to 2 minutes**
...
- Led deployment of **MCP Operator platform** on **AWS ECS/Fargate** enabling **centralized AI tool discovery** and **self-service registration** for organization-wide AI enablement
